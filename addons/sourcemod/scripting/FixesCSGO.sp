...
public void OnPluginStart()
{
	...
	BuildPath(Path_SM, path, sizeof(path), "gamedata/fixescsgo.games.txt");

	if (!FileExists(path))
		SetFailState("Can't find fixescsgo.games.txt gamedata.");

	Handle gameData = LoadGameConfigFile("fixescsgo.games");
